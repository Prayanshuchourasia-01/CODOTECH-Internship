    ...
    <div className="flex flex-col items-center justify-between lg:flex-row py-16">
      <div className=" relative ">
        ...
        <div className="lg:max-w-xl lg:pr-5 relative z-40">
          <p className="flex text-3xl mb-8 font-bold uppercase text font-mono f  ">About Us</p>
      ...
      <div className="relative hidden lg:ml-32 lg:block lg:w-1/2">
        ...
        <div className="abg-orange-400 mx-auto w-fit overflow-hidden rounded-[6rem] rounded-br-none rounded-tl-none">
           ...
           */}
           <img src="https://images.unsplash.com/photo-1688561808434-886a6dd97b8c?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="aboutimage" className='h-[400px] w-[450px] object-cover' />
        </div>
      </div>
    </div>
  </div>
